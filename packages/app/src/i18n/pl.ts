export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BinaryStrike",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BinaryStrike.",
  ...
  "provider.connect.cyberstrikeZen.line1":
    "BinaryStrike Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BinaryStrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BinaryStrike.",
  ...
  "dialog.server.description": "Przełącz serwer BinaryStrike, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja BinaryStrike ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BinaryStrike",
  ...
  "sidebar.gettingStarted.line1": "BinaryStrike zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BinaryStrike",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd BinaryStrike na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BinaryStrike.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BinaryStrike",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BinaryStrike.",
