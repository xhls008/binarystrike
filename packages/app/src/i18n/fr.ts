export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par BinaryStrike",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans BinaryStrike.",
  ...
  "provider.connect.cyberstrikeZen.line1":
    "BinaryStrike Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans BinaryStrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans BinaryStrike.",
  ...
  "dialog.server.description": "Changez le serveur BinaryStrike auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'BinaryStrike ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe BinaryStrike",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'BinaryStrike ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "BinaryStrike inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur BinaryStrike dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour BinaryStrike",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'BinaryStrike sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'BinaryStrike.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'BinaryStrike",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'BinaryStrike.",
