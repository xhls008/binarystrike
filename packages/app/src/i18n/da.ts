export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BinaryStrike",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i BinaryStrike.",
  ...
  "provider.connect.cyberstrikeZen.line1":
    "BinaryStrike Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i BinaryStrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i BinaryStrike.",
  ...
  "dialog.server.description": "Skift hvilken BinaryStrike-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af BinaryStrike ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BinaryStrike-teamet",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, BinaryStrike understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BinaryStrike inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BinaryStrike-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BinaryStrike",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan BinaryStrike ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan BinaryStrike er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BinaryStrike starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BinaryStrike.",
