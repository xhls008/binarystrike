export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BinaryStrike",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BinaryStrike-u.",
  ...
  "provider.connect.cyberstrikeZen.line1":
    "BinaryStrike Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BinaryStrike-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BinaryStrike-u.",
  ...
  "dialog.server.description": "Promijeni na koji se BinaryStrike server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija BinaryStrike-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BinaryStrike timu",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: BinaryStrike još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BinaryStrike uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BinaryStrike server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BinaryStrike-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako BinaryStrike izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BinaryStrike-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BinaryStrike pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BinaryStrike-a.",
