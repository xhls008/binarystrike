...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BinaryStrike",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i BinaryStrike.",
  ...
  "provider.connect.cyberstrikeZen.line1":
    "BinaryStrike Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BinaryStrike.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BinaryStrike.",
  ...
  "dialog.server.description": "Bytt hvilken BinaryStrike-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BinaryStrike ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BinaryStrike-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BinaryStrike ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BinaryStrike inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BinaryStrike-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BinaryStrike",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BinaryStrike ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan BinaryStrike er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BinaryStrike starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BinaryStrike.",
